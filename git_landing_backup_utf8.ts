...
// Injeta o brilho direto no body ÔÇö fora do #app ÔÇö para garantir position:fixed real
...
function injectLandingStyles() {
  ...
  style.textContent = `
    ...
    /* Fade que funde com o fundo da p├ígina */
    #landing-mockup-fade {
      position: absolute;
      bottom: 0;
      left: 24px;
    ...
    /* ÔöÇÔöÇ Mobile App Section ÔöÇÔöÇ */
    ...
    /* ÔöÇÔöÇ Card A: Dashboard mockup ÔöÇÔöÇ */
    ...
    /* ÔöÇÔöÇ Credit card stack mockup (card E) ÔöÇÔöÇ */
    .bento-cc-wrap {
      position: relative;
      width: 100%;
      height: 132px;
    ...
    /* ÔöÇÔöÇ Patrimony mockup (card D) ÔöÇÔöÇ */
    .bento-pat-grid {
      display: grid;
      grid-template-columns: repeat(3, 1fr);
      gap: 8px;
    ...
    /* ÔöÇÔöÇ Calendar mockup (card C) ÔöÇÔöÇ */
    .bento-cal-wrap {
      background: #111111;
      border-radius: 12px;
      border: 1px solid #1C1C1C;
    ...
    /* ÔöÇÔöÇ Responsive Overrides ÔöÇÔöÇ */
  ...
  return `
    <section id="landing-hero">
      <h1 id="landing-headline">
        <span class="headline-part">A gest├úo definitiva para</span>
      ...
      <div id="landing-mockup-wrap">
        <div id="landing-mockup-frame">
          ...
          <img
            ...
            alt="Vis├úo geral do ControlarMais"
            draggable="false"
          />
          <!-- Mobile mockup -->
          <img
...
function bentoGridHTML(): string {
  return `
    <section id="landing-bento-section">
      ...
      <h2 id="landing-bento-heading">Tudo que voc├¬ precisa,<br/>num s├│ lugar.</h2>
      ...
      <div id="landing-bento-grid">
        ...
        <div class="bento-card bento-card-a">
          <div style="display:flex;flex-direction:column;gap:4px;">
            ...
            <p class="bento-card-desc" style="margin:0;">Saldo, entradas e sa├¡das em tempo real.</p>
          </div>
          ...
          <div class="bento-mockup-perspective">
            <div class="bento-mockup-inner">
              ...
              <div style="padding:0;font-family:inherit;display:flex;flex-direction:column;gap:5px;">
                ...
                <!-- Linha 1: card principal + 2├ù2 pequenos -->
                <div style="display:grid;grid-template-columns:1.4fr 1fr;gap:5px;">
                  ...
                  <div style="background:#111111;border-radius:10px;border:1px solid #1C1C1C;overflow:hidden;display:flex;flex-direction:column;">
                    ...
                    <div style="padding:7px 10px;flex:1;display:flex;flex-direction:column;justify-content:center;">
                      ...
                      <div style="font-size:6.5px;color:rgba(255,255,255,0.22);">Previs├úo de saldo livre este m├¬s</div>
                    </div>
                  </div>
                  ...
                  <div style="display:grid;grid-template-columns:1fr 1fr;gap:5px;">
                    ...
                    <div style="background:#111111;border-radius:8px;border:1px solid #1C1C1C;overflow:hidden;">
                      <div style="padding:4px 8px;border-bottom:1px solid rgba(255,255,255,0.04);background:#141414;">
                        <span style="font-size:6px;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:rgba(255,255,255,0.28);">Pr├│x. Pgto</span>
                      </div>
        ...
        <div class="bento-card bento-card-b">
          ...
          <p class="bento-card-desc">Organize cada gasto do jeito que faz sentido para voc├¬.</p>
          <div>
        ...
        <!-- C: Calend├írio de gastos -->
        <div class="bento-card bento-card-c">
          <div style="display:flex;flex-direction:column;gap:4px;">
            <p class="bento-card-title" style="margin:0;">Calend├írio de gastos</p>
            <p class="bento-card-desc" style="margin:0;">Navegue pelos seus gastos dia a dia e entenda seus padr├Áes.</p>
          </div>
          ...
          <div class="bento-cal-wrap">
            ...
            <div class="bento-cal-body">
              <div class="bento-cal-month-label">Mar├ºo 2026</div>
        ...
        <div class="bento-card bento-card-d">
          <div style="display:flex;flex-direction:column;gap:4px;">
            <p class="bento-card-title" style="margin:0;">Controle de patrim├┤nio</p>
            <p class="bento-card-desc" style="margin:0;">Registre im├│veis, ve├¡culos, investimentos e muito mais.</p>
          </div>
          ...
          <div class="bento-pat-grid">
            ...
            <div class="bento-pat-card">
              <div class="bento-pat-tag-row">
                ...
                <span class="bento-pat-tag" style="color:#60a5fa;">Im├│vel</span>
              </div>
              <div class="bento-pat-name">Apartamento</div>
              <div class="bento-pat-sub">Casa ┬À Centro</div>
            ...
            <div class="bento-pat-card">
              <div class="bento-pat-tag-row">
                ...
                <span class="bento-pat-tag" style="color:#fbbf24;">Ve├¡culo</span>
              </div>
              <div class="bento-pat-name">Honda Civic</div>
              <div class="bento-pat-sub">Ve├¡culo ┬À 2022</div>
              <hr class="bento-pat-divider"/>
        ...
        <!-- E: Cart├Áes de cr├®dito -->
        <div class="bento-card bento-card-e">
          <div style="display:flex;flex-direction:column;gap:4px;">
            <p class="bento-card-title" style="margin:0;">Cart├Áes de cr├®dito</p>
            <p class="bento-card-desc" style="margin:0;">Acompanhe faturas, limite dispon├¡vel e vencimentos de todos os seus cart├Áes.</p>
          </div>
              ...
              <div class="bento-cc-inner">
                ...
                <div>
                  ...
                  <div style="display:flex;justify-content:space-between;font-size:8.5px;font-weight:500;color:rgba(255,255,255,0.3);margin-top:4px;">
                    <span>Dispon├¡vel R$ 6.760,00</span>
        ...
        <div class="bento-card bento-card-f">
          <div style="display:flex;flex-direction:column;gap:4px;">
            ...
            <p class="bento-card-desc" style="margin:0;">Escolha o tema que combina com voc├¬ e mude quando quiser.</p>
          </div>
            ...
            <div style="display:flex;flex-direction:column;">
              ...
              <div style="padding:6px;">
                ...
                <div style="display:flex;align-items:center;gap:12px;padding:6px 12px;border-radius:11px;">
                  ...
                  <span style="margin-left:auto;font-size:11px;color:rgba(255,255,255,0.3);font-weight:500;white-space:nowrap;">Jo├úo Silva</span>
                </div>
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;padding:6px 12px;border-radius:11px;">
                  ...
                  <!-- Switch ativo (dark ON): thumb ├á direita, track laranja -->
...
function pricingHTML(): string {
  const visibleFeatures = [
    ...
    'Controle de cart├Áes de cr├®dito',
    'Controle de patrim├┤nio',
    'Calend├írio de gastos',
    'Conex├Áes Open Finance',
    'Lembretes de pagamentos',
    'App Mobile (iOS e Android) em breve',
  ];

  const hiddenFeatures = [
    'Controle de transa├º├Áes',
    'Sincroniza├º├úo em tempo real',
  ];
  ...
  return `
    <section id="landing-pricing-section">
      ...
      <h2 id="landing-pricing-heading">PROMO├ç├âO DE LAN├çAMENTO</h2>
      ...
      <div style="display:flex; flex-direction:column; align-items:center; gap:14px; margin: 0 0 32px 0; max-width: 400px; margin-left: auto; margin-right: auto;">
        ...
        <p style="font-size: 14px; line-height: 1.6; color: rgba(255,255,255,0.45); margin: 0; font-weight: 400; text-align: center;">
          Nosso app est├í prestes a chegar na Google Play Store e App Store, por isso estamos dando <strong style="color:#fff;">50% OFF</strong> para quem garantir antes do lan├ºamento.
        </p>
      </div>

      <div id="pricing-timer-wrap">
        <p id="pricing-timer-tag"><span></span>A oferta de lan├ºamento termina em:</p>
      ...
      <div id="landing-pricing-card" style="border-top: none; border-top-left-radius: 0; border-top-right-radius: 0;">
        ...
        <div id="landing-pricing-card-top">
          ...
          <div id="landing-pricing-price" style="display:flex; flex-direction:column; gap:2px; margin-bottom:12px;">
            ...
            <div style="display:flex; align-items:baseline; gap:4px;">
              ...
              <span class="pricing-period" style="font-size:14px; color:rgba(255,255,255,0.4); margin-left:4px;">/m├¬s</span>
            </div>
          </div>
        </div>
        ...
        <div id="landing-pricing-cta">
          <button id="landing-pricing-signup-btn">Come├ºar agora</button>
        </div>
  ...
  const testimonials = [
    {
      ...
      text: "O Controlar+ mudou completamente como vejo o meu neg├│cio. Finalmente parei de usar planilhas complexas e agora tenho tudo na palma da m├úo."
    },
    {
      name: "Rafael Lima",
      role: "Desenvolvedor",
      image: "https://randomuser.me/api/portraits/men/32.jpg",
      text: "Design absurdo e muito r├ípido. A funcionalidade de controle de patrim├┤nio me ajudou a organizar meus investimentos de forma clara."
    },
    {
      name: "Juliana Mendes",
      role: "Designer Aut├┤noma",
      image: "https://randomuser.me/api/portraits/women/32.jpg",
      text: "Simplesmente incr├¡vel! A interface no modo escuro ├® um show ├á parte. Nunca foi t├úo f├ícil acompanhar minhas faturas e categorias."
    },
    {
      name: "Carlos Eduardo",
      role: "M├®dico",
      image: "https://randomuser.me/api/portraits/men/46.jpg",
      text: "Testei v├írios apps, mas a clareza deste dashboard n├úo tem igual. Consigo prever meu saldo do m├¬s em dois cliques."
    },
    {
      name: "Fernanda Silva",
      role: "Estudante",
      image: "https://randomuser.me/api/portraits/women/44.jpg",
      text: "Adorei a facilidade de uso. Controlar meus gastos semanais se tornou um h├íbito natural depois que comecei a usar."
    }
  ];
...
function faqHTML(): string {
  const faqs = [
    {
      q: "Como o Controlar+ garante a seguran├ºa dos meus dados?",
      a: "Utilizamos criptografia de ponta a ponta e padr├Áes de seguran├ºa banc├íria para proteger suas informa├º├Áes. Seus dados s├úo somente seus e nunca s├úo compartilhados com terceiros."
    },
    {
      q: "Posso conectar contas de qualquer banco?",
      a: "Atualmente suportamos a maioria dos grandes bancos nacionais e diversas institui├º├Áes financeiras atrav├®s do Open Finance. A lista ├® atualizada constantemente."
    },
    {
      q: "Existe vers├úo do aplicativo para celular?",
      a: "Sim, nosso aplicativo completo para dispositivos iOS e Android j├í est├í em desenvolvimento e entrar├í em fase beta em breve. Voc├¬ ter├í todo controle na palma da sua m├úo."
    },
    {
      q: "Posso cancelar minha assinatura quando quiser?",
      a: "Com certeza. N├úo possu├¡mos fidelidade ou taxas ocultas. Voc├¬ pode cancelar sua assinatura a qualquer momento e continuar usando o plano at├® o fim do ciclo vigente."
    }
  ];

  return `
    <section id="landing-faq-section">
      <p id="landing-faq-label">D├║vidas Frequentes</p>
...
function setupPricingTimer() {
  ...
  if (!endTime) {
    // Definimos 10 dias a partir do primeiro acesso para criar urg├¬ncia
    const target = Date.now() + (10 * 24 * 60 * 60 * 1000) - (15 * 60 * 1000); // 10 dias menos 15 min para n├úo ver o 10 cravado
...
function animateTextFlip() {
  const words = ["organizar rotinas", "potencializar lucros", "alcan├ºar liberdade", "realizar sonhos"];
...
// Scroll: mockup vai de deitado (rotateX 18┬░) para em p├® (0┬░)

function setupMockupScroll() {
  const frame = document.getElementById('landing-mockup-frame');
  if (!frame) return;

  const MAX_SCROLL = 500; // px at├® endireitar completamente
...
export function renderLanding() {
  ...
  // Brilho no body ÔÇö fora do #app ÔÇö para position:fixed n├úo ser afetado por ancestors
  mountBrilho();
  injectLandingStyles();

  // For├ºa s├│ o html como scroll container (body e #app ficam vis├¡veis)
  ...
  // Entrada el├ística do card de plano ÔÇö mesmo feel do MonthSelector
